  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        transition={{ duration: 1 }}
        viewport={{ once: true }}
        className='text-center text-[16px] text-[--gray]'
      >
        Let&apos;s start ASAP.
      </motion.p>
      ...
      <div className='absolute inset-0 -z-10 h-full bg-black bg-opacity-85'></div>
      <div className='absolute -top-28 left-0 h-[40%] w-full bg-linear-gradient blur-3xl'></div>
      <div className='absolute bottom-0 left-0 h-[40%] w-full bg-linear-gradient blur-3xl'></div>
